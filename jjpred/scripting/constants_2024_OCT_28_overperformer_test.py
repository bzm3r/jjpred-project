...
from jjpred.analysisdefn import FbaRevDefn, OutperformerSettings
...
analysis_defn = FbaRevDefn.new_comparison_analysis(
    ...
    "2024-OCT-28",
    RefillType.WEEKLY,
    outperformer_settings=OutperformerSettings(
        False, DateOffset(2, DateUnit.MONTH)
    ),
    extra_descriptor="overperformer",
)
