...
args = RefillDefnArgs(
    analysis_date="2025-SEP-18",
    current_seasons=CurrentSeasonDefn(FW=25, SS=25),
    dispatch_date="2025-SEP-18",
    master_sku_date="2025-SEP-18",
    sales_and_inventory_date="2025-SEP-18",
    warehouse_inventory_date="2025-SEP-18",
    ...
    refill_type=RefillType.END_OF_NOV_2025,
...
analysis_defn_website = FbaRevDefn.from_args(
    args.update(
...
analysis_defn_qty_box_rework = FbaRevDefn.from_args(
    args.update(
        jjweb_reserve_info=JJWebPredictionInfo(
            reservation_expr=DEFAULT_RESERVATION_EXPR,
            force_po_prediction_for_reservation=True,
        ...
        use_old_current_period_method=False,
        extra_descriptor="qty_box_rework",
    )
)
