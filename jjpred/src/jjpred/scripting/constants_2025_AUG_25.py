...
args = RefillDefnArgs(
    analysis_date="2025-AUG-27",
    current_seasons=CurrentSeasonDefn(FW=25, SS=25),
    dispatch_date="2025-AUG-25",
    master_sku_date="2025-AUG-26",
    sales_and_inventory_date="2025-AUG-27",
    warehouse_inventory_date="2025-AUG-26",
...
analysis_defn_test_jj_expanded = FbaRevDefn.from_args(
    args.update(
        ...
        sales_and_inventory_date="2025-AUG-25",
    )
)
