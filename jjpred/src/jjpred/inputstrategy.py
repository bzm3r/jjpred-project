...
class RefillType(EnumLike):
    ...
    CUSTOM_2025_JUL_14 = auto()
    CUSTOM_2025_JUL_21 = auto()
    END_OF_NOV_2025 = auto()
    END_OF_DEC_2025 = auto()
    ...
    def end_date(
        ...
        match self:
            ...
            case (
                RefillType.CUSTOM_2025_JUL_01
                | RefillType.CUSTOM_2025_JUL_14
                | RefillType.CUSTOM_2025_JUL_21
            ):
                start_date = Date.from_datelike(start_date)
                assert (
                    (start_date == Date.from_datelike("2025-JUL-01"))
                    or (start_date == Date.from_datelike("2025-JUL-14"))
                    or (start_date == Date.from_datelike("2025-JUL-21"))
                ), start_date
            ...
            case RefillType.END_OF_DEC_2025:
                start_date = Date.from_datelike(start_date)
                assert start_date == Date.from_datelike("2025-OCT-06")
                return Date.from_datelike("2026-JAN-01")
            case value:
